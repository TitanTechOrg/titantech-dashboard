      ...
      <div className="flex flex-col items-center justify-center gap-8 sm:py-16">
        <article>
          ...
          <p className="text-left">
            TitanTech is an analytics solution for Tap Titans 2 that aims to
            provide real-time data and insights to help clan members and leaders
        ...
        <div className="w-full">
          ...
          <ol className="list-inside list-decimal text-left">
            ...
            <li>
              Use the link provided by the TitanTech bot to access your
              Dashboard
            </li>
          </ol>
          <Code className="mt-4 text-wrap">
            <div className="flex items-center">
              ...
              <span>
                Please note that only (Grand) Master rank can generate a token
                for your clan
              </span>
            </div>
          </Code>
