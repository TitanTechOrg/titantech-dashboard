...
export default function Overview() {
    ...
    const { data: overviewPlayers, isLoading: isLoadingOverviewPlayers } = useOverviewPlayers(selectedRaidId['raid-overview-selector']);
    ...
    const findRaid = useMemo(
        () => raidList?.raids?.find((r) => r.raid_id === selectedRaidId['raid-overview-selector']),
        [selectedRaidId['raid-overview-selector'], raidList?.raids]
    );

    const { data: raidCycles } = useRaidCycles(selectedRaidId['raid-overview-selector']);
        ...
        <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-4 sm:flex-row">
                ...
                {isLoadingOverviewPlayers ? (
                    ...
                    findRaid && (
                        <RaidOverviewInfo raidId={selectedRaidId['raid-overview-selector']} raid={findRaid} overviewPlayers={overviewPlayers} />
                    )
                )}
            </div>
            {isLoadingOverviewPlayers ? (
            ...
            {selectedRaidId['raid-overview-selector'] && findRaid && <RaidTable raidId={selectedRaidId['raid-overview-selector']} raid={findRaid} />}
        </div>
    );
}
