import { RaidResearchNode } from '../types';

export const raidResearchData: Record<number, RaidResearchNode[]> = {
  0: [
    {
      id: 'node_0_0',
      type: 'RAID',
      levels: { total: 10, current: 0, bonusPer: 10 },
    },
  ],
  1: [
    {
  ...
  3: [
    {
      id: 'node_3_0',
      type: 'HEAD',
      levels: { total: 8, current: 0, bonusPer: 9 },
    },
    {
      id: 'node_3_1',
      type: 'LIMB',
  ...
  4: [
    {
      id: 'node_4_0',
      type: 'LOJAK',
      levels: { total: 15, current: 0, bonusPer: 4 },
    },
    {
      id: 'node_4_1',
      type: 'TAKEDAR',
  ...
  6: [
    {
      id: 'node_6_0',
      type: 'HEAD_ARMOR',
      levels: { total: 25, current: 0, bonusPer: 2 },
    },
    {
      id: 'node_6_1',
      type: 'LIMB_ARMOR',
  ...
  7: [
    {
      id: 'node_7_0',
      type: 'LOJAK_AFFLICTION',
      levels: { total: 9, current: 0, bonusPer: 6 },
    },
    {
      id: 'node_7_1',
      type: 'TAKEDAR_AFFLICTION',
      levels: { total: 9, current: 0, bonusPer: 6 },
    },
    {
      id: 'node_7_2',
      type: 'JUKK_AFFLICTION',
      levels: { total: 9, current: 0, bonusPer: 6 },
    },
    {
      id: 'node_7_3',
      type: 'STERL_AFFLICTION',
      levels: { total: 9, current: 0, bonusPer: 6 },
    },
  ],
  8: [
  ...
  10: [
    {
      id: 'node_10_0',
      type: 'MOHACA_AFFLICTION',
      levels: { total: 9, current: 0, bonusPer: 6 },
    },
    {
      id: 'node_10_1',
      type: 'TERRO_AFFLICTION',
      levels: { total: 9, current: 0, bonusPer: 6 },
    },
    {
      id: 'node_10_2',
      type: 'KLONK_AFFLICTION',
      levels: { total: 9, current: 0, bonusPer: 6 },
    },
    {
      id: 'node_10_3',
      type: 'PRIKER_AFFLICTION',
      levels: { total: 9, current: 0, bonusPer: 6 },
    },
  ],
  11: [
    {
      id: 'node_11_0',
      type: 'RAID',
      levels: { total: 7, current: 0, bonusPer: 8 },
    },
  ],
  12: [
    {
  ...
  14: [
    {
      id: 'node_14_0',
      type: 'LIMB',
      levels: { total: 5, current: 0, bonusPer: 10 },
    },
    {
      id: 'node_14_1',
      type: 'HEAD',
  ...
  15: [
    {
      id: 'node_15_0',
      type: 'MOHACA',
      levels: { total: 8, current: 0, bonusPer: 7 },
    },
    {
      id: 'node_15_1',
      type: 'KLONK',
  ...
  19: [
    {
      id: 'node_19_0',
      type: 'HEAD_ARMOR',
      levels: { total: 17, current: 0, bonusPer: 3 },
    },
    {
      id: 'node_19_1',
      type: 'LIMB_ARMOR',
  ...
  20: [
    {
      id: 'node_20_0',
      type: 'PRIKER_AFFLICTION',
      levels: { total: 5, current: 0, bonusPer: 12 },
    },
    {
      id: 'node_20_1',
      type: 'KLONK_AFFLICTION',
  ...
  24: [
    {
      id: 'node_24_0',
      type: 'RAID',
      levels: { total: 20, current: 0, bonusPer: 15 },
    },
  ],
};
