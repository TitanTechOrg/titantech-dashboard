    ...
    <PageContainer>
      <div className="flex flex-col gap-6">
        <div className="text-left">
          ...
          <p>
            Use the calculator to optimize alchemy ingredients to craft the most
            wildcards possible. Fill in your ingredients to get started.
          </p>
        </div>
        <div className="flex flex-col flex-wrap items-start justify-evenly gap-4 sm:flex-row">
          <Recipes
            title="Craftable ingredients"
