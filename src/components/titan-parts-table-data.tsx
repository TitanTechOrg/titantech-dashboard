import {
  TitanPartMap,
  TitanPartMapPlayerPerspective,
} from '@/constants/titans';
...
export type RaidTitanPartPlayerPerspective =
  keyof typeof TitanPartMapPlayerPerspective;
...
const findPart = (
  partName: RaidTitanPart,
  data: TitanPart[]
): TitanPart | undefined =>
  data.find((part) => part.name === TitanPartMap[partName]);

const findSequencePart = (
  partName: RaidTitanPart,
  data: TitanSequenceParts[] | undefined
): TitanSequenceParts | undefined =>
  data?.find((part) => part.name === TitanPartMap[partName]);
...
const getCurseTypeColor = (
  part: TitanSequenceParts | undefined,
  curseType: CurseTypes | undefined
): CurseColors => {
...
function TableRowArmour({
  ...
  if (sequenceParts) {
    healthPercentage = percentage(
      sequenceParts.health,
      sequenceParts.current_health
    );
  }

  let textColour = isNegativeNumber
    ? overkillTextColor
  ...
  const displayText = isNegativeNumber
    ? isOverThreshold(value, threshold)
      ? getPartDamageText(value)
      : '--'
    : getPartDamageText(value);
  ...
  return (
    <Tooltip
      showArrow={true}
      content={`${healthPercentage}%`}
      isDisabled={healthPercentage === 0}
    >
      <div
...
function TableRowBody({
  ...
  return (
    ...
    >
      <div
        className={`${textColour} bg-primary/40 col-span-1 row-span-1 min-h-8 w-full min-w-[80px] rounded-b font-semibold subpixel-antialiased dark:bg-blue-600/40`}
      >
        {displayText}
        {showHealthbars && displayText && (
          <Progress
...
const TitanOverlayImages = {
  ...
  Klonk:
    "before:bg-[url('https://titantech-static.s3.nl-ams.scw.cloud/titans/Klonk-0b1a8f82.webp')]",
  Lojak:
    "before:bg-[url('https://titantech-static.s3.nl-ams.scw.cloud/titans/Lojak-3ff6694b.webp')]",
  Mohaca:
    "before:bg-[url('https://titantech-static.s3.nl-ams.scw.cloud/titans/Mohaca-9685de65.webp')]",
  Priker:
    "before:bg-[url('https://titantech-static.s3.nl-ams.scw.cloud/titans/Priker-359c25d5.webp')]",
  Sterl:
    "before:bg-[url('https://titantech-static.s3.nl-ams.scw.cloud/titans/Sterl-72f3a3ad.webp')]",
  Takedar:
    "before:bg-[url('https://titantech-static.s3.nl-ams.scw.cloud/titans/Takedar-6cf45888.webp')]",
  Terro:
    "before:bg-[url('https://titantech-static.s3.nl-ams.scw.cloud/titans/Terro-74c392e8.webp')]",
} as const;
...
function TitanPartCellData({
  partNames,
  showHealthbars,
  parts,
  damagedPartsValue,
  curse_type,
}: TitanPartCellDataType) {
  ...
  const isSkeletalSmashTarget =
    !!armourPart?.skeleton_smash_target || !!bodyPart?.skeleton_smash_target;
  let borders = isTargetPart
  ...
  return (
    <div
      className={`relative flex min-w-fit flex-col gap-y-2 rounded-lg border-4 ${borders}`}
    >
      <div
        className={`${showHealthbars ? '' : 'hidden'} absolute top-[34px] left-0 z-10 w-[100%] rotate-[-45deg] rounded-sm border-2 ${
      ...
      <TableRowArmour
        ...
        cursedColor={
          armourPart?.cursed
            ? getCurseTypeColor(armourPart, curse_type)
            : undefined
        }
      />
      <TableRowBody
        value={bodyValue}
        sequenceParts={bodyPart}
        isOffstratPart={!!bodyPart?.target == false}
        showHealthbars={showHealthbars}
      />
    </div>
  );
...
export function TitanPartTableData({
  damagedParts,
  titanData,
  showHealthbars,
}: TitanPartTableDataProps) {
  ...
  const tinyScreenScale =
    isTinyScreen && !showHealthbars ? 'scale-75' : 'scale-90';
  ...
  return (
    <div
      ...
      } ${tinyScreenScale} md:scale:100 relative w-fit min-w-fit text-center before:absolute before:top-0 before:right-0 before:bottom-0 before:left-0 before:z-0 before:bg-contain before:bg-center before:bg-no-repeat before:opacity-[40%] sm:scale-100 lg:scale-90 xl:scale-100`}
    >
      <div className={`grid ${colGap} grid-cols-3 gap-y-1 sm:gap-x-3`}>
        <TitanPartCellData
          ...
          parts={cursedParts}
          damagedPartsValue={[
            findPart('Armor Arm Right', damagedParts)?.value,
            findPart('Body Arm Right', damagedParts)?.value,
          ]}
        ...
        <TitanPartCellData
          ...
          parts={cursedParts}
          damagedPartsValue={[
            findPart('Armor Head', damagedParts)?.value,
            findPart('Body Head', damagedParts)?.value,
          ]}
          curse_type={curse_type}
          showHealthbars={showHealthbars}
        />
        <TitanPartCellData
          ...
          parts={cursedParts}
          damagedPartsValue={[
            findPart('Armor Arm Left', damagedParts)?.value,
            findPart('Body Arm Left', damagedParts)?.value,
          ]}
          curse_type={curse_type}
          showHealthbars={showHealthbars}
        />
      ...
      <div className={`grid ${colGap} my-2 grid-cols-3 gap-y-1 sm:gap-x-3`}>
        <TitanPartCellData
          ...
          parts={cursedParts}
          damagedPartsValue={[
            findPart('Armor Hand Right', damagedParts)?.value,
            findPart('Body Hand Right', damagedParts)?.value,
          ]}
          curse_type={curse_type}
          showHealthbars={showHealthbars}
        />
        <TitanPartCellData
          ...
          parts={cursedParts}
          damagedPartsValue={[
            findPart('Armor Chest', damagedParts)?.value,
            findPart('Body Chest', damagedParts)?.value,
          ]}
          curse_type={curse_type}
          showHealthbars={showHealthbars}
        />
        <TitanPartCellData
          ...
          parts={cursedParts}
          damagedPartsValue={[
            findPart('Armor Hand Left', damagedParts)?.value,
            findPart('Body Hand Left', damagedParts)?.value,
          ]}
          curse_type={curse_type}
          showHealthbars={showHealthbars}
        />
      ...
      <div
        className={`grid ${colGap} mx-11 grid-cols-2 items-center gap-y-1 sm:gap-x-3`}
      >
        <TitanPartCellData
          partNames={['Armor Leg Right', 'Body Leg Right']}
          parts={cursedParts}
          damagedPartsValue={[
            findPart('Armor Leg Right', damagedParts)?.value,
            findPart('Body Leg Right', damagedParts)?.value,
          ]}
          curse_type={curse_type}
          showHealthbars={showHealthbars}
        />
        <TitanPartCellData
          ...
          parts={cursedParts}
          damagedPartsValue={[
            findPart('Armor Leg Left', damagedParts)?.value,
            findPart('Body Leg Left', damagedParts)?.value,
          ]}
          curse_type={curse_type}
          showHealthbars={showHealthbars}
        />
